      ...
      <header className="border-b border-gray-200 bg-white">
        <div className="max-w-7xl mx-auto px-8 py-6">
          <div className="flex justify-between items-end">
            <div>
              <h1 className="text-3xl font-serif text-gray-900 mb-1">Your Name</h1>
              <p className="text-base text-gray-700">Department of [Your Field] and [School Name]</p>
            </div>
        ...
        {activeTab === 'bio' && (
          <div className="flex gap-16">
            ...
            <div className="w-80 flex-shrink-0">
              <div className="w-80 h-80 rounded-full bg-gray-200 overflow-hidden flex items-center justify-center mb-8">
                <span className="text-gray-400">Your Photo</span>
              </div>
              
              {/* Contact Links */}
              <div className="flex justify-center gap-6 text-gray-700">
                <a href="mailto:your.email@university.edu" className="hover:text-gray-900 text-lg font-medium">
                  Email
                </a>
